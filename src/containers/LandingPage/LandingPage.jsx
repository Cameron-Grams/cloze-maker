    ...
    render() {
        ...
        <div className="App">
            ...
            <ul>
               ...
               <li>Either type or copy and paste the original text into the "Exercise Text" area and advance to Build the Cloze.</li>     
               <li>Select the words to remove from the original text and add to the vocabulary words that students will select from for the exercise.</li>     
